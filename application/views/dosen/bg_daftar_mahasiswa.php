                        ...
                        <div class="widget-box">
										<div class="widget-header header-color-blue">
											<h5 class="bigger lighter">
												<i class="icon-table"></i>Input Nilai Mahasiswa</h5>
													...
													<tbody>
														<tr>
															...
															foreach($mhs->result_array() as $k)
															{
																	...
																	echo '<td><a class="btn btn-small btn-primary" href="'.base_url().'index.php/dosen/input_nilai/'.$k['nim'].'" title="Masukan Nilai - '.$k['nama_mahasiswa'].'"><i class="icon-on right icon-arrow-right"></i> Masukan Nilai</a></td>
