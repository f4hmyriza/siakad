                                           ...
                                           <?php echo $this->session->flashdata('save_mk'); ?>
                                            <form action="<?php echo base_url();?>index.php/admin/simpan_mk" method="post">
                                              <table width="60%" border="0" cellspacing="1" cellpadding="1">
                                                ...
                                                <tr>
                                                  <td width="20%" align="right">Kode Matakuliah</td>
                                                  <td width="5%" align="center">:</td>
                                                  <td width="75%"><label>
                                                    <input name="kd_mk" type="text" id="kd_mk" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="nama_mk" type="text" id="nama_mk" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="jum_sks" type="text" id="jum_sks" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="semester" type="text" id="semester" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="prasyarat_mk" type="text" id="prasyarat_mk" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="kode_jur" type="text" id="kode_jur" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  <td>&nbsp;</td>
