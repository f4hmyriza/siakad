                        ...
                        <div class="widget-box">
										...
										<div class="widget-body">
                                           ...
                                           <?php echo $this->session->flashdata('save_dosen'); ?>
                                            <form action="<?php echo base_url();?>index.php/admin/simpan_dosen" method="post">
                                              <table width="60%" border="0" cellspacing="1" cellpadding="1">
                                                ...
                                                <tr>
                                                  <td width="20%" align="right">Kode Dosen</td>
                                                  <td width="5%" align="center">:</td>
                                                  <td width="75%"><label>
                                                    <input name="kd_dosen" type="text" id="kd_dosen" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="nidn" type="text" id="nidn" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="nama_dosen" type="text" id="nama_dosen" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  <td>&nbsp;</td>
                                                  <td>&nbsp;</td>
                                                  <td><button class="btn btn-small btn-primary"><i class="icon-download-alt"></i> Simpan Data</button> <a href="<?php echo base_url();?>index.php/admin/dosen" class="btn btn-danger btn-small"><i class="icon-external-link"></i> Kembali</a>
