                                           ...
                                           <?php echo $this->session->flashdata('save_mahasiswa'); ?>
                                            <form action="<?php echo base_url();?>index.php/admin/simpan_mahasiswa" method="post">
                                              <table width="60%" border="0" cellspacing="0" cellpadding="0" >
                                                ...
                                                <tr>
                                                  <td width="21%" align="right">NIM</td>
                                                  <td width="4%" align="center">:</td>
                                                  <td width="75%"><label>
                                                    <input name="nim" type="text" id="nim" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="nama_mahasiswa" type="text" id="nama_mahasiswa" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="angkatan" type="text" id="angkatan" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="jurusan" type="text" id="jurusan" size="50">
                                                  </label></td>
                                                </tr>
                                                <tr>
