...
?>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												<table width="100%" >
													<thead>
														<tr>
															<th width="913" align="left"><span class="label label-large label-pink arrowed-right">MATAKULIAH YANG AKAN DIINPUTKAN NILAINYA</span></th>
														</tr>
													</thead>
                                                               ...
                                                               <?php
																...
																$tot_sks += $value['jum_sks'];
																	...
																	echo '<td>'.$value['nama_dosen'].'</td>
																			...
																			<td>'.$value['Peserta'].'</td>
																			<td><a href="'.base_url().'index.php/admin/form_input_nilai/'.$value['nim'].'/'.$value['kd_jadwal'].'">Input</a></td>';
																		if($status=='0')
																		{
																			echo '<td>
																			<a id="'.$value['nim'].'|'.$value['kd_jadwal'].'" href="#"><div>Batalkan</div></a>
																			</td>';
																		}
																}
												...
												<table width="100%" border="0" cellspacing="1" cellpadding="1" class="table table-striped table-bordered table-hover">
												  <tr>
												    <td colspan="9"><span class="label label-large label-pink arrowed-right">MATAKULIAH YANG TERSIMPAN</span></td>
											      </tr>
												  <tr>
												    <td><b>No</b></td>
												    <td><b>Kode MK</b></td>
		...
		foreach($khs->result_array() as $value)
		{
			if($temp=='')
			{
				...
				<td align="center"><a href="'.base_url().'index.php/admin/hapus_nilai/'.$value['nim'].'/'.$value['kd_mk'].'" class="link"
				onClick=\'return confirm("Anda yakin ingin melakukan edit data ini...??")\'>Perbaharui Nilai</a></td>';
				$no++;
				$totalNH=0;
				$totalSKS=0;
			}
