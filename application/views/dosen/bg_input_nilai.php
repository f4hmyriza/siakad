...
?>
                                                               ...
                                                               <?php
																...
																$tot_sks += $value['jum_sks'];
																	...
																	echo '<td>'.$value['nama_dosen'].'</td>
																			...
																			<td>'.$value['Peserta'].'</td>
																			<td><a href="'.base_url().'index.php/dosen/form_input_nilai/'.$value['nim'].'/'.$value['kd_jadwal'].'">Input</a></td>';
																		if($status=='0')
																		{
																			echo '<td>
		...
		foreach($khs->result_array() as $value)
		{
			if($temp=='')
			{
				...
				<td align="center"><a href="'.base_url().'index.php/dosen/hapus_nilai/'.$value['nim'].'/'.$value['kd_mk'].'" class="link"
