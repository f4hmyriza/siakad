										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												<table width="100%">
													<thead>
														<tr>
															<th width="913" align="left">DAFTAR DOSEN DAN MATAKULIAH YANG DIPEGANG<span class="label label-warning arrowed arrowed-left"></span></th>
														</tr>
													</thead>
													...
													<tbody>
														<tr>
                                                            ...
                                                            <a href="<?php echo base_url();?>index.php/admin/mk" class="btn btn-small btn-primary"><i class="icon-external-link"></i> Kembali Ke Data Matakuliah</a>
                                                            </td>
														</tr>
													</tbody>
												</table>
