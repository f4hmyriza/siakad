													...
													<thead>
														<tr>
															<th width="913" align="left">
																<i class="icon-user"></i>
																<span class="label label-large label-pink arrowed-right">DATA MAHASISWA </span><span class="label label-warning arrowed arrowed-right"><?php $query = $this->db->query("select * from tbl_mahasiswa"); 
																echo $query->num_rows();
														...
														<tr>
															<td class=""><table width="100%"  border="1" style="border-collapse:collapse"  cellspacing="2" cellpadding="2" class="table table-striped table-bordered table-hover">
															  <tr>
															    ...
															    <td><b>Angkatan</b></td>
															    <td><b>Jurusan</b></td>
															    <td><b>Kelas Program</b></td>
															    <td colspan="2">
                                                                <?php
																echo '<a href="'.base_url().'index.php/admin/tambah_mahasiswa" class="btn btn-small btn-primary"><i class="icon-edit "></i> Tambah Data</a>';
																?>
                                                                </td>
														      </tr>
                                                              <?php
															  ...
															  <tr>
															    ...
															    <td><?php
																echo '<a href="'.base_url().'index.php/admin/edit_mahasiswa/'.$d['nim'].' "class="btn btn-small btn-purple" style="float:left;"><i class="icon-leaf"></i>Edit</a></td>
																<td>
																<a href="'.base_url().'index.php/admin/hapus_mahasiswa/'.$d['nim'].'"
				onClick=\'return confirm("Anda yakin ingin menghapus data ini...??")\' class="btn btn-mini btn-danger" ><i class="icon-ban-circle"></i>Hapus</a>';
			?>
                                                                </td>
														      </tr>
															  <?php
