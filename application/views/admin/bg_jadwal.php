                        ...
                        <div class="widget-box">
										<div class="widget-header header-color-blue">
											<h5 class="bigger lighter">
												...
												Data Matakuliah yang Akan di Tempuh Pada Semester Berjalan</h5>
											...
											<div class="widget-main no-padding">
												<table width="100%">
													...
													<tbody>
														<tr>
															<td width="913" class="">
                                                            <table width="100%" border="1" style="border-collapse:collapse" cellspacing="1" cellpadding="1" class="table table-striped table-bordered table-hover">
															  <tr>
															    <td><b>Kode MK</b></td>
															    <td><b>Matakuliah</b></td>
															    <td><b>Smstr</b></td>
															    <td><b>SKS</b></td>
															    <td colspan="2"><b>Dosen</b></td>
															    <td><b>Kelas</b></td>
															    <td><b>Jadwal</b></td>
															    <td><b>Quota</b></td>
															    <td><b>Peserta</b></td>
															    <td><b>Calon Peserta</b></td>
															    <td colspan="2"><?php echo '<a href="'.base_url().'index.php/admin/tambah_jadwal" class="btn btn-small btn-primary"> <i class="icon-edit"></i> Tambah Jadwal</a>'; ?>
	...
	foreach ($jdwl->result_array() as $value) 
	{
		if(($temp=='') || ($value['kd_mk']!=$temp)) {			
			...
			$rows[$index] .='<td id="'.'cell_'.$value['kd_mk'].'_'.$value['kelas'].'">'.$value['kd_dosen'].'</td><td>'.$value['nama_dosen'].'</td>
				...
				<td align="center">
				<a href="'.base_url().'index.php/admin/hapus_jadwal/'.$value['kd_jadwal'].'"
				onClick=\'return confirm("Anda yakin ingin menghapus data ini...??")\' class="btn btn-mini btn-danger" style="float:left;"><i class="icon-ban-circle"></i>Hapus</a>
				</td></tr>';
			$index++;
			$temp=$value['kd_mk'];
	}		
