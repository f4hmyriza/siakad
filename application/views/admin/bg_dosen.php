													...
													<thead>
														<tr>
															<th width="913" align="left">
																<i class="icon-user"></i>
																<span class="label label-large label-pink arrowed-right">DATA DOSEN </span><span class="label label-warning arrowed arrowed-right"><?php $query = $this->db->query("select * from tbl_dosen"); 
																echo $query->num_rows();
														...
														<tr>
															<td class=""><table width="100%"  border="1" style="border-collapse:collapse"  cellspacing="2" cellpadding="2" class="table table-striped table-bordered table-hover">
															  <tr>
															    ...
															    <td colspan="3">
                                                                <?php
																echo '<a href="'.base_url().'index.php/admin/tambah_dosen" class="btn btn-small btn-primary"><i class="icon-edit "></i> Tambah Data</a>';
																?>
                                                                </td>
														      </tr>
                                                              <?php
															  ...
															  <tr>
															    ...
															    <?php
																echo '<td><a href="'.base_url().'index.php/admin/dosen_mk/'.$d['kd_dosen'].'"><span class="label label-large label-yellow arrowed-in">Matakuliah yang diajarkan</span></a></td>
																
																<td><a href="'.base_url().'index.php/admin/edit_dosen/'.$d['kd_dosen'].' "class="btn btn-small btn-purple" style="float:left;"><i class="icon-leaf"></i>Edit</a></td>
																<td>
																<a href="'.base_url().'index.php/admin/hapus_dosen/'.$d['kd_dosen'].'"
