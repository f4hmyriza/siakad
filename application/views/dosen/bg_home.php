                        ...
                        <div class="widget-box">
										<div class="widget-header header-color-blue">
											<h5 class="bigger lighter">
												...
												Selamat Datang Di Sistem Informasi Akademik Online
											</h5>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												<table width="100%">
													...
													<tbody>
														<tr>
														  <td class=""><span class="label label-large label-pink arrowed-right">Harap ganti password Anda untuk mencegah hal-hal yang tidak diinginkan</span></td>
													  </tr>
														<tr>
															<td width="913" class=""><div class="row-fluid">
								<div class="span7 infobox-container">
									<div class="infobox infobox-green  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number"><?php $query = $this->db->query("select * from tbl_mahasiswa"); echo $query->num_rows(); ?></span>
											<div class="infobox-content">Data Mahasiswa</div>
										</div>
									...
									<div class="infobox infobox-blue  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number"><?php $query = $this->db->query("select * from tbl_dosen"); echo $query->num_rows(); ?></span>
											<div class="infobox-content">Data Dosen</div>
										</div>
									...
									<div class="infobox infobox-pink  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number"><?php $query = $this->db->query("select * from tbl_mk"); echo $query->num_rows(); ?></span>
											<div class="infobox-content">Data Matakuliah</div>
										</div>
									...
									<div class="infobox infobox-orange2  ">
										...
										<div class="infobox-data">
											<span class="infobox-data-number">{elapsed_time}</span>
											<div class="infobox-content">Load Halaman</div>
										</div>
