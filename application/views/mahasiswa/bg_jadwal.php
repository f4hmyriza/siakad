...
?>
                                                            ...
                                                            <form name="datafrs" id="datafrs" method="POST" action="<?php echo base_url();?>index.php/mahasiswa/simpan_krs">
															  <table width="121%" border="0" cellspacing="1" cellpadding="1">
															    ...
															    <tr>
															      ...
															      <td>&nbsp;</td>
															      <td align="right">Program Kelas</td>
															      <td align="center">:</td>
															      <td><label>
	...
	foreach ($jdwl->result_array() as $value) 
	{
		if(($temp=='') || ($value['kd_mk']!=$temp)) {			
			...
			$linkpeserta = $peserta;
			if($peserta >0)
			$linkpeserta = '<a href="'.base_url().'index.php/mahasiswa/peserta/'.$value['kd_jadwal'].'_1
			...
			if($calonpeserta >0)
			$linkcalonpeserta = '<a href="'.base_url().'index.php/mahasiswa/peserta/'.$value['kd_jadwal'].'_0
