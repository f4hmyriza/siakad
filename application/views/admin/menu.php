...
<ul class="nav nav-list">
					...
					<li>
						<a href="<?php echo base_url();?>index.php/admin/dosen" class="dropdown-toggle">
							<i class="icon-desktop"></i>
<span class="menu-text">Data Dosen</span></a> </li>

					<li>
						<a href="<?php echo base_url();?>index.php/admin/mk">
							<i class="icon-list"></i>
							<span class="menu-text"> Data Matakuliah</span>
						</a>
					</li>
