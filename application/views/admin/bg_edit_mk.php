                        ...
                        <div class="widget-box">
										...
										<div class="widget-body">
                                           ...
                                           <?php echo $this->session->flashdata('save_mk'); ?>
                                            <form action="<?php echo base_url();?>index.php/admin/simpan_mk" method="post">
											  ...
											  ?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="nama_mk" type="text" id="nama_mk" size="50" value="<?php echo $m['nama_mk']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="jum_sks" type="text" id="jum_sks" size="50" value="<?php echo $m['jum_sks']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="semester" type="text" id="semester" size="50" value="<?php echo $m['semester']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  <td align="right">Persyaratan</td>
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="prasyarat_mk" type="text" id="prasyarat_mk" size="50" value="<?php echo $m['prasyarat_mk']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  ...
                                                  <td align="center">:</td>
                                                  <td><label>
                                                    <input name="kode_jur" type="text" id="kode_jur" size="50" value="<?php echo $m['kode_jur']; ?>">
                                                  </label></td>
                                                </tr>
                                                <tr>
                                                  <td>&nbsp;</td>
                                                  <td>&nbsp;</td>
                                                  <td><button class="btn btn-small btn-primary"><i class="icon-download-alt"></i> Simpan Data</button> <a href="<?php echo base_url();?>index.php/admin/mk" class="btn btn-danger btn-small"><i class="icon-external-link"></i> Kembali</a>
