														...
														<tr>
                                                            ...
                                                            <table width="100%" border="1" cellspacing="2" cellpadding="2">
															  <tr>
															    ...
															    <td><b>Jurusan</b></td>
															    <td><b>Program Kelas</b></td>
															    <td><b>Status Persetujuan</b></td>
															    <td><b>SKS</b></td>
															    <td><b>Detail KRS</b></td>
														      </tr>
															  <?php
															  	$no=1;
																foreach($mhs->result_array() as $k)
																{
																	...
																	if($k['status']=='0')
																	{
																		$st= "Belum Disetujui";	
																		$warna = "#FFFF66";
																		$link = base_url().'index.php/dosen/detail_krs/'.$k['nim'].'/'.$k['status'];
																	}
																	else if ($k['status']=='1')
																	{
																		$st= "Sudah Disetujui";	
																	...
																	echo '<td><span class="label label-large label-pink arrowed-right">'.$st.'</span></td>
																	<td></td>
																	<td><a class="btn btn-small btn-primary" href="'.$link.'" title="Detail Kartu Rencana Studi - '.$k['nama_mahasiswa'].'"><i class="icon-rss bigger-150 middle"></i> Cek Detail <i class="icon-on right icon-arrow-right"></i></a></td>
																	</tr>';
																	$no++;									
																}
															  ?>
